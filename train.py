...
'''Word Embedding Matrix: It creates an embedding matrix using pre-trained 
GloVe word vectors for words in the vocabulary. 
Words not found in the GloVe embeddings are initialized with zeros.'''
embeddings_index = {}
...
# Load/Save the model, tokenizer and label encoder
model.save('model.h5')
